...
import auth from '../assets/auth.png'; // Import the image
...
function Login() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${auth})` }} // Set the background image
    >
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-center text-sm mt-4">
            Don’t have an account? <a href="/register" className="text-purple-600">Sign up</a>
          </p>
        </form>
      </div>
    </div>
